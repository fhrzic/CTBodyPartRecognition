...
def main():
    ...
    modelConfig.input_shape = {"input_shape": (1,128,128,128), "output_classes": 14, "head": "ATT"}
    ...
    modelConfig.info = f"VoxCNN_ATT2_Patches_NMDD_BCH_SAROS"
    ...
    _training = model_training_app(_train_dl, _valid_dl, _model_config, f"VoxCNN_Patches_NMDD_BCH_SAROS_ATT2/")
