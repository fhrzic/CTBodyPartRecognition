...
from Utils.train_model_Patches_NMDD_BCH_SAROS import *
...
datasetConfig.image_dimension = 318
...
modelConfig.input_shape = {"input_shape": (1,128,128,128), "output_classes": 14, "head": "Normal"}
modelConfig.model_name = 'VoxCNN_Patches'
modelConfig.loss = 'bce'
modelConfig.valid_epochs = "1_1"
modelConfig.early_stopping = 15
modelConfig.learning_rate = 1e-6#"Auto" #"Auto" #1e-3
modelConfig.opt_name = 'ADAMW'
modelConfig.epochs = 500
modelConfig.wandb = False
modelConfig.info = f"VoxCNN_lr_Patches_NMDD_BCH_SAROS"
...
# Set path
_root_path = "Dummy_for_obtaining/"

# Load model
_training = model_training_app(None, None, _model_config, _root_path)
_training.load_model("/mnt/SSD/Franko/Desktop/Train_Models_Patches_BCH_NMDD_SAROS/VoxCNN_Patches_NMDD_BCH_SAROS/VoxCNN_Patches_ADAMW_0.001_bcevalid_best_model.pth")
...
with pd.ExcelWriter(f"{datasetConfig.type}_VoxCNN_3D_Patches_output.xlsx", engine='xlsxwriter') as writer:
