...
# Set dataset
datasetConfig.labels_xlsx_path = "/run/user/1001/gvfs/smb-share:server=mig_data1,share=mig_projects/Object_Detection_QC/Evaluate_NNMD/Data/Output-Labels.xlsx"
datasetConfig.cheetsheet_xlsx_path = "/run/user/1001/gvfs/smb-share:server=mig_data1,share=mig_projects/Object_Detection_QC/Evaluate_NNMD/Data/cheetsheet.xlsx"
datasetConfig.imgs_png_home_path = "/run/user/1001/gvfs/smb-share:server=mig_data1,share=mig_projects/Object_Detection_QC/Evaluate_NNMD/Data/Images"
...
for _i, _image in enumerate(_paths_storage):
    ...
    _dir = os.path.join("Output_4k", _dir)
