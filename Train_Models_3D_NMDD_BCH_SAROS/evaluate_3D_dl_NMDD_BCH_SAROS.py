...
modelConfig.info = f"VoxCNN_3D_NMDD_BCH_SAROS"
...
# Set path
_root_path = "VoxCNN_3D_NMDD_BCH_SAROS_eval/"

# Load model
_training = model_training_app(None, None, _model_config, _root_path)
_training.load_model("/mnt/SSD/Franko/Desktop/Train_Models_3D_BCH_NMDD_SAROS/VoxCNN_3D_NMDD_BCH_SAROS/VoxCNN_ADAMW_0.001_bcevalid_best_model.pth")
