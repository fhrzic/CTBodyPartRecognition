...
from Utils.train_model_NMDD_BCH_SAROS import *
...
modelConfig.info = f"Eff3_NMDD_BCH"
...
# Set path
_root_path = "Dense161_NMDD_BCH_SAROS_eval/"

# Load model
_training = model_training_app(None, None, _model_config, _root_path)
_training.load_model("/home/franko/Desktop/Train_BCH_NMDD_SAROS/Dense161_NMDD_BCH_SAROS/dense161_ADAMW_0.001_bcevalid_best_model.pth")
